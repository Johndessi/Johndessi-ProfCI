...
function construireInstructionsLectureMethodique(referentiel) {
  const consigneEntrees = referentiel
    ...
    : `Aucun référentiel de caractéristiques n'est disponible pour ce type de texte précis : détermine les « entrées » les plus pertinentes toi-même, à partir d'une analyse rigoureuse du texte, en respectant STRICTEMENT la contrainte ci-dessous sur la nature des entrées.`;
